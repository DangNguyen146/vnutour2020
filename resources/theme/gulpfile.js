...
function watchFiles() {
    gulp.watch(folder.src + "assets/images/**/*", gulp.series(imageMin));
    gulp.watch(folder.src + "assets/fonts/**/*", gulp.series(fonts));
    gulp.watch(folder.src + "scss/**/*", gulp.series(css));
    gulp.watch(folder.src + "js/**/*", gulp.series(javascript));
}
// watch all changes
